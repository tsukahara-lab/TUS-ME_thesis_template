...
\begin{tcolorbox}[title={余談：参考文献の書き方}]
    欧文文献の参考文献表記には複数の形式があり，学会やジャーナルによって異なります.
    卒業論文・修士論文では，日本機械学会論文集の体裁に則った独自のスタイルを用いることになっています.
    略記の有無（著者名，誌名・書名）や巻・号の表記方法（Volume，Vol. ，太字など）に特に注意しましょう．
\end{tcolorbox}
...
\begin{tcolorbox}[title={第~\ref{ch:bibtex}~章の参考文献}, colback=yellow!5!white, colframe=yellow!75!black, coltitle=black]
    \begin{itemize}
