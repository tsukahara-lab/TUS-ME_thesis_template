...
しかし，学会の講演論文執筆の際はこれらの機能に対応していない場合もあるため，念のためレガシーな \LaTeX のタイプセット方法等についても説明をしています．
...
\begin{tcolorbox}[title={\texttt{tsukahara-lab/TUS-ME\_thesis\_template}}]
    \begin{tabular}{ll}
        ...
        \verb|main.pdf|     & \verb|main.tex| をタイプセットした \verb|pdf| ファイル \\
...
今皆さんが読んでいるこの \verb|pdf| ファイルは \verb|template-manual/template-manual.pdf| で，\verb|template-manual/main.tex| を基に作成しています．
...
また，タイプセットの際には \verb|latexmk| という機能を使用し，その際 \verb|latexmkrc| が必要になります．
\verb|latexmk| でタイプセットした際のファイル出力先を \verb|latex.out/| に設定してあります．
\verb|latexmk| の使用方法も含め，具体的なタイプセットの方法等については第~\ref{ch:howtouse}~章を参照してください．
